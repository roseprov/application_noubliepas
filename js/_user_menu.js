 ...
 * le modificateur --fermer est ajouté au ul.user__menu du menu
 */
...
var userMenu = {
    lblMenuFerme: 'Menu utilisateur',
    lblMenuOuvert: 'Fermer menu utilisateur',
    ...
    configurerNav: function ()
    {
        ...
        $(".user__controle").on('click', userMenu.ouvrirFermerNav.bind(userMenu));
    },
    ...
    {
        if($(".user__menu").hasClass("user__menu--ouvert"))
        {
            $(".user__menu").removeClass().addClass("user__menu user__menu--fermer");
            // $(".menu__libelle").html(this.lblMenuFerme);
            // $(".menu__icone").html(this.svgHamburger);
        }
        else
        {
            $(".user__menu").removeClass().addClass("user__menu user__menu--ouvert");
