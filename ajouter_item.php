...
if($strCodeOperation == 'ajout')
{
    ...
    //Insertion
    if($intCodeErreur == 00000 && $strCodeOperation == 'ajout')
    {
        $estComplete = 0;

        $strRequete = "INSERT INTO t_item (item, echeance, est_complete, id_liste)
                        VALUES (:nom_item, :echeance, :est_complete, :id_liste)";
        ...
        $pdosResultat->bindParam(':est_complete', $estComplete);
...
<main class="wrap">
    ...
    <div class="contenu editerAjouterItem">
        <div class="titre">
            <h1 id="contenu">AJOUTER UN ITEM<br><span>à la liste </span><?php echo $arrListe['nom_liste']; ?></h1>
        </div>
        <form action="ajouter_item.php" method="get">
            ...
            <div class="boutons">
                <button name="btn_ajouter" value="ajouter" class="boutonPrincipal">Ajouter</button>
